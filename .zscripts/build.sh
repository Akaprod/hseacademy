...
# ============================================================================
# DB : NE PAS packager la DB dans le build.
# La production DOIT utiliser DATABASE_URL (env var) pointant vers la DB
# de production externe. Ne jamais copier la DB de test dans le build.
# ============================================================================
echo "ℹ️  Aucune DB packagée dans le build — la prod utilisera DATABASE_URL (env var)."
