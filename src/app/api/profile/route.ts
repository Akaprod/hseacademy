...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    if (body.cvContactPhone !== undefined) allowed.cvContactPhone = body.cvContactPhone || null;
    if (body.cvContactEmail !== undefined) allowed.cvContactEmail = body.cvContactEmail || null;
    if (body.cvContactLocation !== undefined) allowed.cvContactLocation = body.cvContactLocation || null;
